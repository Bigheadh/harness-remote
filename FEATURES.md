...
- [ ] Task subtasks — break tasks into independently trackable child tasks (POST /api/tasks/:id/subtasks, GET /api/tasks/:id/subtasks)
- [ ] Activity feed — combined chronological timeline of all task events (GET /api/tasks/:id/activity)
